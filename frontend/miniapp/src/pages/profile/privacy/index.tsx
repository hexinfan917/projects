        ...
        <View className='content-body'>
          ...
          <View className='section'>
            ...
            <Text className='section-text'>
              尾巴PetWay（以下简称"我们"或"本小程序"）深知个人信息对您的重要性，我们一向庄严承诺保护使用我们的产品和服务的用户（以下统称"用户"或"您"）的个人信息及隐私安全。您在使用尾巴PetWay时，我们可能会收集和使用您的相关个人信息。我们希望通过《尾巴PetWay隐私政策》（以下简称"本政策"）向您说明我们在您使用尾巴PetWay时如何收集、使用、保存、共享和转让这些信息，以及我们为您提供的访问、更新、删除和保护这些信息的方式。
            </Text>
            <Text className='section-text'>
              本政策将帮助您了解以下内容：{'\n'}
              1. 我们如何收集和使用您的个人信息{'\n'}
            ...
            <Text className='section-text highlight'>
              请您在使用尾巴PetWay前，仔细阅读并了解本政策。一旦您开始使用我们的各项产品或服务，即表示您已充分理解并同意本政策。阅读过程中，如果您有任何疑问，可通过本政策文末的联系方式与我们联系。
            </Text>
          </View>
          ...
          <View className='section'>
            ...
            <Text className='section-text'>
              ...
              当您预订活动、报名公益活动或添加出行人时，我们需要收集真实姓名和身份证号，用于：{'\n'}
              • 购买保险{'\n'}
              • 景区实名核验{'\n'}
              • 确保出行安全{'\n\n'}
              ...
              当您使用地图、查找附近宠物友好场所时，我们会请求获取您的位置信息，用于展示附近的POI（兴趣点）和活动规划。
            </Text>
          ...
          <View className='section'>
            ...
            <Text className='section-text'>
              我们不会与尾巴PetWay以外的任何公司、组织和个人分享您的个人信息，但以下情形除外：{'\n'}
              1. 在获取明确同意的情况下共享：获得您的明确同意后，我们会与其他方共享您的个人信息。{'\n'}
              2. 与活动服务提供商共享：为完成您的订单（如景区门票、酒店住宿、活动组织服务），我们可能需要将您的姓名、手机号、身份证号共享给相关服务提供商。{'\n'}
              3. 与保险公司共享：如您购买活动保险，我们需要将姓名、身份证号共享给承保的保险公司。{'\n'}
