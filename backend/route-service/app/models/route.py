...
class Route(Base):
    ...
    pet_insurance_title: Mapped[Optional[str]] = mapped_column(String(50), default="宠物意外险", comment="宠物保险标题")
    pet_insurance_unit: Mapped[Optional[str]] = mapped_column(String(10), default="狗", comment="宠物保险计价单位")
    pet_insurance_desc: Mapped[Optional[str]] = mapped_column(String(200), default="保障宠物活动中突发意外医疗费用，最高保额¥5000", comment="宠物保险描述")
    person_insurance_title: Mapped[Optional[str]] = mapped_column(String(50), default="人身意外险", comment="人身保险标题")
    person_insurance_unit: Mapped[Optional[str]] = mapped_column(String(10), default="人", comment="人身保险计价单位")
    person_insurance_desc: Mapped[Optional[str]] = mapped_column(String(200), default="保障出行人意外伤害及医疗，最高保额¥200,000", comment="人身保险描述")
