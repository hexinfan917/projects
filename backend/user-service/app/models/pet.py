...
class PetProfile(Base):
    ...
    breed: Mapped[str] = mapped_column(String(50), nullable=False, comment="品种")
    ...
    vaccine_book: Mapped[Optional[str]] = mapped_column(String(500), nullable=True, comment="疫苗本照片URL")
    ...
    profile_status: Mapped[str] = mapped_column(String(20), default="complete", comment="档案完整状态 complete/incomplete")
    source: Mapped[str] = mapped_column(String(50), default="manual", comment="来源 manual/personality_test")
